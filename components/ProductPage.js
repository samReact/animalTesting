    ...
    <Row style={{ height: '10%' }}>
      <Col style={{ width: '20%', padding: 4 }}>
        <Button iconLeft white full>
          <Icon name="arrow-back" style={{ position: 'absolute', left: -4 }} />
        </Button>
      </Col>
    ...
    <Row style={{ height: '30%' }}>
      <Col style={{ width: '30%', padding: 4 }}>
        <Image
          ...
          source={{
            uri:
              'https://centifoliabio.fr/8454-large_default/shampoing-sans-p-titoto.jpg',
          }}
        />
      </Col>
      <Col style={{ flexWrap: 'wrap', flexDirection: 'column' }}>
        <Row style={{ padding: 4 }} size={2}>
          <Text style={{ fontWeight: 'bold' }}>brand_name - product_name</Text>
        </Row>
        <Row size={1}>
          <Image
